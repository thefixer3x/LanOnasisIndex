...
// Enhanced Timeline Data with more sophisticated milestones
const timelineMilestones = [
  {
    year: '2020',
    title: 'The Genesis',
    description: 'Founded with a vision to transform African tech landscape through innovative solutions and AI-powered platforms.',
    icon: Rocket,
  ...
  },
  {
    ...
    description: 'Introduced our flagship AI platform, revolutionizing business intelligence and compliance across Africa.',
    icon: Brain,
    color: 'from-purple-500 to-pink-500',
    achievement: 'First enterprise clients onboarded'
  },
  {
    year: '2022',
    title: 'Regional Expansion',
    description: 'Expanded operations to 5 African countries, serving over 100 enterprise clients with localized solutions.',
    icon: Globe2,
    color: 'from-green-500 to-emerald-500',
    achievement: '100+ enterprise clients'
  },
  {
    year: '2023',
    title: 'Innovation Award',
    description: 'Recognized as "Most Innovative FinTech Solution" at Africa Tech Summit, cementing our industry leadership.',
    icon: Award,
    color: 'from-yellow-500 to-orange-500',
    achievement: 'Industry recognition achieved'
  },
  {
    year: '2024',
    title: 'Strategic Partnerships',
    description: 'Formed key partnerships with major financial institutions and regulatory bodies across the continent.',
    icon: Users2,
    color: 'from-indigo-500 to-blue-500',
    achievement: 'Series A funding completed'
  },
  {
    year: '2025',
    title: 'Global Recognition',
    description: 'Achieved unicorn status and expanded services to international markets, redefining global fintech standards.',
    icon: Sparkles,
    color: 'from-pink-500 to-violet-500',
    achievement: 'Unicorn status achieved'
  },
];
...
const TimelineMilestone: React.FC<TimelineMilestoneProps> = ({ milestone, index }) => {
  ...
  return (
    <motion.div
      ...
      className="relative flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-12 group"
    >
      <motion.div 
        className={`flex-shrink-0 w-20 h-20 rounded-2xl bg-gradient-to-br ${milestone.color} 
      ...
      <div className="flex-1 text-center md:text-left">
        ...
        <motion.h3 
          className="text-2xl font-semibold mb-3 group-hover:text-secondary transition-colors duration-300"
          whileHover={{ x: 5 }}
        >
          {milestone.title}
        </motion.h3>
        <p className="text-gray-400 mb-3 leading-relaxed">{milestone.description}</p>
        <motion.div 
          className="inline-flex items-center text-sm font-medium text-accent bg-accent/10 px-3 py-1 rounded-full"
          whileHover={{ scale: 1.05 }}
        >
                    ...
                    >
                      <div className={index % 2 === 1 ? 'lg:col-start-2' : ''}>
                        ...
                        <motion.div 
                          ...
                          whileHover={{ scale: 1.05 }}
                        >
                          <button className="btn-primary btn-magnetic group">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {products.map((product, index) => (
                    <motion.div
                      ...
                      className="enhanced-card group cursor-pointer"
                      whileHover={{ y: -8 }}
                    >
                      <motion.div 
                        className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${product.gradient} 
