...
const TESTIMONIALS = [
  {
    ...
    rating: 5,
    description:
      "The Continuity Concierge carries our decisions across markets and working sessions. We spend less time rebuilding context and more time making the next defensible move.",
    avatarUrl:
